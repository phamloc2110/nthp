	...
	<div class="inqbox float-e-margins">
		...
		<div class="inqbox-content">
			<div class="alert alert-info" style="font-size: 15px; background-color: rgba(157, 248, 89, 0.62); border-color: rgba(157, 248, 89, 0.62);">
				...
				<b style="font-color:red;">Lưu Ý:</b> Để Token Nick Comment Simsimi Lâu Die Bạn Nên GET "Token For iPhone" Ở  <code>"<a href="/AUTO-AND-BOT-LIKE-FACEBOOK-GET-TOKEN.html" target="_blank"> ĐÂY </a> " </code><br /> Nếu Bạn Không Muốn Dùng Nick Khác Để Cmt Thì Bạn Có Thể Dùng Chính Nick Của Bạn Bằng Cách Sử Dụng Mã Token Của Bạn Ở Ô Bên Dưới.
			</div>
