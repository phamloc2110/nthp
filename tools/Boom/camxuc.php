<div class="col-md-5">
	<div class="box box-success">
		...
		<div class="box-content">
			...
			<font style="color:#23c6c8;">Bước 2:</font> Nhập ID Vào Khung Bên Dưới Sau Đó Thực Hiện Boom Cảm Súc. <br />
			<hr>
			...
			<div class="form-group">
				<button class="btn btn-success btn-block" id="boomcamsuc" onclick="post_BoomCamSuc();">
