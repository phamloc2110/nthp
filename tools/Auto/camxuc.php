	...
	<div class="box box-success">
		...
		<div class="box-content">
			...
			<div class="form-group red">
				<label for="name">Chọn Số Lượng Cảm Súc - Kéo Thanh Trượt Để Điều Chỉnh</label>
				<center>
					<div id="soluong" class="label label-info" align="center">5</div>
				</center>
				<input class="form-control" type="range" name="soluong" min="1" max="50" id="limit" value="5" onchange="document.getElementById('soluong').innerHTML=this.value;">
			</div>
			<div class="form-group">
				<button class="btn btn-success btn-block" id="camsuc" onclick="post_Camsuc();">
