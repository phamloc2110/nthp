	...
	<div class="box box-success">
		...
		<div class="box-content">
			...
			<div class="form-group">
				...
				<center>
					<div id="soluong" class="label label-info" align="center">10</div>
				</center>
				<input class="form-control" type="range" name="soluong" min="1" max="30" id="limit" value="10" onchange="document.getElementById('soluong').innerHTML=this.value;">
			</div>
			<div class="form-group">
