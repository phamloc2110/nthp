<div class="col-md-5 ">
	<div class="box box-success">
		<div class="box-title box-header with-border">
			<h4><i class="fa fa-thumbs-up"></i> Auto Share - Tăng Lượt Share Tự Động</h4>
...
<h4><strong><p class="text-danger"> Hệ Thống Tăng Lượt Chia Sẻ Facebook Theo ID Bất Kỳ</p></strong></h4>
			...
			<div class="form-group">
				...
				<input class="form-control" type="range" name="soluong" min="1" max="25" id="limit" value="5" onchange="document.getElementById('soluong').innerHTML=this.value;">
			</div>
			<div class="form-group">
