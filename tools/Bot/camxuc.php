<?php  
$res = @mysql_query("SELECT * FROM `BotCamsuc` WHERE `idfb`= '".$_SESSION[idfb]."'");
		...
		<div class="box-content">
			...
			<div class="alert alert-warning" style="background-color: rgba(245, 215, 66, 0.32); border-color: rgba(245, 215, 66, 0.32);">
				<span style="color: black; font-size: 15px;"><i class="fa fa-reddit-square"></i> Bot Cảm Xúc Status, Ảnh : <font color ="blue"><?php echo ($key == 1) ? "Hoạt Động" : "Không Sử Dụng";?> </font></span><br />
                    			...
                    			<span style="color: black; font-size: 15px;"><i class="fa fa-reddit-square"></i> Loại Cảm Xúc Sử Dụng : <font color ="blue"><?php echo $getcmt[camsuc] ? $getcmt[camsuc] : "Chưa Cài Đặt"; ?></font></span>
			</div>
			...
			<div class="input-group">
				<span class="input-group-addon"><i class="fa fa-key"></i></span>
				<input type="text" class="form-control" id="likecmt" name="likecmt" value="" style="color: red; font-size: 15px;" placeholder="Điền 1 Nếu Muốn Cảm Xúc Cmt Hoặc 0 Nếu Không Muốn">
				<span class="input-group-addon"><i class="fa fa-key"></i></span>
			</div><br />
			<div class="input-group">
				<span class="input-group-addon"><i class="fa fa-paste"></i>
				</span>
                                      <select id="camsuc" class="form-control">	
			...
			<div class="form-group">
				<button class="btn btn-success btn-block" id="botcamsuc" onclick="post_BotCamsuc();">
