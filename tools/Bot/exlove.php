...
<div class="col-md-12">
	<div class="box box-success">
		...
		<div class="box-content">
			...
			<div class="input-group">
				<span class="input-group-addon"><i class="fa fa-key"></i></span>
				<input type="text" class="form-control" id="likecmt" name="likecmt" value="" style="color: red; font-size: 15px;" placeholder="Điền 1 Nếu Muốn EX Love Cmt Hoặc 0 Nếu Không Muốn">
				<span class="input-group-addon"><i class="fa fa-key"></i></span>
			</div><br />
